        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="/front/pages/accueil/pageService.php">Mes services</a></li>
    ...
    <div class="container-fluid text-center">
        <div class="row content">
            ...
            <div class="col-sm-8 text-left">
                <h1>
                    <center> Page Services </center>
                </h1>
                <hr>
                <p>Le service de la recette a en charge l'accomplissement de la formalité de l'enregistrement et le recouvrement des impôts, droits et taxes lui incombant en application du Code des impôts. Il recouvre également les produits domaniaux de la Nouvelle-Calédonie.
                    ...
                    retenue à la source.
                    À cela, il faut ajouter les droits supplémentaires et pénalités relatifs à ces impôts et taxes.</p>
            </div>
            <div class="col-sm-2 sidenav">
                <div class="well">
                    <p>ADS</p>
